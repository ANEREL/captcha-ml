# -*- coding: utf-8 -*-
"""
Created on Wed Jul  1 12:28:58 2020
...
for path, label in [('./data/clock/', [0,1]), ('./data/anti/', [0,1]), ('./data/done/', [1,0])]:
...
keras.models.save_model(model, 'model_keras_classif_finetuned_binary')
