...
class DQN(nn.Module):
    def __init__(self, img_height, img_width):
        ...
        self.out = nn.Linear(in_features=32, out_features=2) # 2 possible moves - left or right
...
class DQN(nn.Module):
    ...
    def __init__(self, img_height, img_width):
        ...
        self.head = nn.Linear(in_features=linear_input_size, out_features=2)
...
class Agent():
    ...
    def select_action(self, state, policy_net):
        ...
        if rate > random.random(): # Randomly select an action
...
memory_size = 100000
lr = 0.001
num_episodes = 200 # run for more episodes for better results
